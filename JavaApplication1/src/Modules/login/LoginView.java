...
public class LoginView extends javax.swing.JFrame implements config {
    ...
    public LoginView() {
        ...
        try {
            ...
            LogFiles.setFileContentAsStackTrace(LOG_FILE, e, "Falhou ao Recuperar Usuário");
        }
    ...
    public void login() throws IOException {
        ...
        try {
            ...
            LogFiles.setFileContentAsStackTrace(LOG_FILE, "Usuário: " + account + " logou com sucesso");
        } catch (BibliotecaException e) {
            LogFiles.setFileContentAsStackTrace(LOG_FILE, "Usuário: " + account + " tentou realizar login");
            JOptionPane.showMessageDialog(this, e.getMessage());
            return;
        }
        lastUser.salvarUsuario(account);
        this.dispose();
        LogFiles.setFileContentAsStackTrace(LOG_FILE, "Usuário: " + account + " acessou a Tela Principal");
        TelaPrincipal principal = new TelaPrincipal(account);
